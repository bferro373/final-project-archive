...
QT_MOC_LITERAL(1, 10, 17), // "viewOffsetChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 6), // "offset"
QT_MOC_LITERAL(4, 36, 16), // "viewScaleChanged"
QT_MOC_LITERAL(5, 53, 5) // "scale"

    },
    "GraphView\0viewOffsetChanged\0\0offset\0"
    "viewScaleChanged\0scale"
};
...
void GraphView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->viewOffsetChanged((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        ...
        {
            using _t = void (GraphView::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphView::viewOffsetChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GraphView::*)(qreal );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphView::viewScaleChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GraphView::viewOffsetChanged(QPoint _t1)
{
...
// SIGNAL 1
void GraphView::viewScaleChanged(qreal _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
