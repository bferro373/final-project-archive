/****************************************************************************
** Meta object code from reading C++ file 'RegistersWidget.h'
**
...
#include <memory>
#include "../../../../src/widgets/RegistersWidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'RegistersWidget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 32, 15), // "setRegisterGrid"
QT_MOC_LITERAL(4, 48, 15), // "openContextMenu"
QT_MOC_LITERAL(5, 64, 5), // "point"
QT_MOC_LITERAL(6, 70, 7) // "address"

    },
    "RegistersWidget\0updateContents\0\0"
    "setRegisterGrid\0openContextMenu\0point\0"
    "address"
};
...
static const uint qt_meta_data_RegistersWidget[] = {
 ...
 // slots: parameters
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void, QMetaType::QPoint, QMetaType::QString,    5,    6,
...
void RegistersWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RegistersWidget *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->updateContents(); break;
        case 1: _t->setRegisterGrid(); break;
        case 2: _t->openContextMenu((*reinterpret_cast< QPoint(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject RegistersWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<CutterDockWidget::staticMetaObject>(),
    qt_meta_stringdata_RegistersWidget.data,
    qt_meta_data_RegistersWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
