...
QT_MOC_LITERAL(1, 12, 11), // "graphClosed"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "GraphWidget\0graphClosed\0"
};
...
void GraphWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphWidget::graphClosed)) {
                *result = 0;
                return;
            }
        }
